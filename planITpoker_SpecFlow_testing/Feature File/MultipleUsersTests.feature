...
Scenario: Second user reconnects to the game room
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And a second user logs into the same Game Room as "Jack"
	And I remove Jack from the game room
	And Second user reconnects to the game room
	When I ask for information from getPlayersAndState
	Then I should see that the second user's name is "Jack"

Scenario: Second user tries to edit the Game Room by adding a countdown timer
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And a second user logs into the same Game Room as "Jack"
	And Jack tries to edit the Game Room by adding a countdown timer
...
Scenario: Moderator removes second user, after second user has voted
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user tries to vote before game starts
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user tries to submit an estimate, as observer
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to skip a story
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And I create a story named "Second Test Story"
...
Scenario: Second user, as observer, tries to reset the in-game timer, as observer
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to reveal the cards
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to clear votes before the voting process ends
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to clear votes after the voting process ends
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to end the voting process
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to change the title of a story before the game starts
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to change the title of a story after the game starts
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to change the title of a story after he votes
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And I create a story named "Test Story"
	And a second user logs into the same Game Room as "Jack"
...
Scenario: Second user, as observer, tries to edit the Game Room by adding a countdown timer
	Given I log in via Quick Play as "John"
	And I create a Game Room named "Test Room"
	And a second user logs into the same Game Room as "Jack"
	And I assign Jack as observer

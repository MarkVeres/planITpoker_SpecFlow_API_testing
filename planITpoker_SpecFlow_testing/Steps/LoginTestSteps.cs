...
namespace planITpoker_SpecFlow_testing
{
    ...
    public class LoginTestSteps
    {
        ...
        {
            var login = new LoginMethods(client, loginContext);
        ...
        {
            var room = new RoomMethods(loginContext, client);
        ...
        {
            var game = new GameMethods(loginContext.gameId, loginContext.gameCode, client, loginContext.cookie);
